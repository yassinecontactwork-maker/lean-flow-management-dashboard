...
[Consulter le rapport PDF](./LeanFlowSystem.pdf)
...
![Ordres de fabrication](./docs/images/ordres-fabrication.jpg)

### Buffers DDMRP

![Buffers DDMRP](./docs/images/buffers-ddmrp.jpg)

### Alertes et conflits

![Alertes et conflits](./docs/images/alertes.jpg)
